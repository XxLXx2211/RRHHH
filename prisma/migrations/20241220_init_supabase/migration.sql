...
-- CreateEnum
CREATE TYPE "CanalRecepcion" AS ENUM ('Web', 'Referido', 'Oficina', 'RedesSociales', 'BolsaEmpleo', 'EntregaCVPresencial', 'WhatsApp', 'PortalWeb', 'LlamadaDirecta', 'Facebook');

-- CreateEnum
CREATE TYPE "TipoContacto" AS ENUM ('Llamada', 'Correo', 'Presencial', 'Mensaje', 'Entrevista', 'EntrevistaTelefonica', 'WhatsApp');

-- CreateEnum
CREATE TYPE "EstatusCandidato" AS ENUM ('Asignado', 'NoElegible', 'Elegible', 'Renuncia', 'NoAsistio', 'AConsiderar', 'NoInteresado', 'NoContesta', 'Rechazado', 'Nuevo', 'EnProceso', 'Entrevistado', 'Contratado', 'Descartado', 'EnEspera');
