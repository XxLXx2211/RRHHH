...
export async function GET(
  ...
  try {
    ...
    const candidate = await SupabaseCandidateService.getById(id)
...
export async function PUT(
  ...
  try {
    ...
    const candidate = await SupabaseCandidateService.update(id, data)
...
export async function DELETE(
  ...
  try {
    ...
    await SupabaseCandidateService.delete(id)
